...
#
# However, when we do this, we also import `jsoncsv/__init__.py'. If this
...
setup_dict = dict(
    ...
    entry_points={
        'console_scripts': [
            'jsoncsv_cli = jsoncsv.main:entry_point'
        ],
        # if you have a gui, use this
        # 'gui_scripts': [
        #     'jsoncsv_gui = jsoncsv.gui:entry_point'
        # ]
    }
)
